 ...
 */
final class Version20250211080336 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livraison (id INT AUTO_INCREMENT NOT NULL, trajet_id INT DEFAULT NULL, numero VARCHAR(20) NOT NULL, adresse VARCHAR(255) NOT NULL, code_postal VARCHAR(10) NOT NULL, ville VARCHAR(50) DEFAULT NULL, client_nom VARCHAR(50) NOT NULL, client_prenom VARCHAR(50) NOT NULL, client_email VARCHAR(255) NOT NULL, client_telephone VARCHAR(20) NOT NULL, date DATE NOT NULL, creneau VARCHAR(1) DEFAULT NULL, statut VARCHAR(20) NOT NULL, UNIQUE INDEX UNIQ_A60C9F1FD12A823 (trajet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
