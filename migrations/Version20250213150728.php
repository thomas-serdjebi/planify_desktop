 ...
 */
final class Version20250213150728 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE historique (id INT AUTO_INCREMENT NOT NULL, livraison_id INT NOT NULL, id_livreur_prv_id INT DEFAULT NULL, id_livreur_new_id INT DEFAULT NULL, contenu VARCHAR(255) NOT NULL, evenement VARCHAR(255) NOT NULL, statut_livraison_prv VARCHAR(50) DEFAULT NULL, statut_livraison_new VARCHAR(50) DEFAULT NULL, date DATETIME NOT NULL, INDEX IDX_EDBFD5EC8E54FB25 (livraison_id), INDEX IDX_EDBFD5EC47DCDE44 (id_livreur_prv_id), INDEX IDX_EDBFD5EC147C9158 (id_livreur_new_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE livraison (id INT AUTO_INCREMENT NOT NULL, trajet_id INT DEFAULT NULL, tournee_id INT NOT NULL, numero VARCHAR(20) NOT NULL, adresse VARCHAR(255) NOT NULL, code_postal VARCHAR(10) NOT NULL, ville VARCHAR(50) DEFAULT NULL, client_nom VARCHAR(50) NOT NULL, client_prenom VARCHAR(50) NOT NULL, client_email VARCHAR(255) NOT NULL, client_telephone VARCHAR(20) NOT NULL, date DATE NOT NULL, creneau VARCHAR(1) DEFAULT NULL, statut VARCHAR(20) NOT NULL, UNIQUE INDEX UNIQ_A60C9F1FD12A823 (trajet_id), INDEX IDX_A60C9F1FF661D013 (tournee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE historique ADD CONSTRAINT FK_EDBFD5EC47DCDE44 FOREIGN KEY (id_livreur_prv_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE historique ADD CONSTRAINT FK_EDBFD5EC147C9158 FOREIGN KEY (id_livreur_new_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE livraison ADD CONSTRAINT FK_A60C9F1FD12A823 FOREIGN KEY (trajet_id) REFERENCES trajet (id)');
        $this->addSql('ALTER TABLE livraison ADD CONSTRAINT FK_A60C9F1FF661D013 FOREIGN KEY (tournee_id) REFERENCES tournee (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE historique DROP FOREIGN KEY FK_EDBFD5EC47DCDE44');
        $this->addSql('ALTER TABLE historique DROP FOREIGN KEY FK_EDBFD5EC147C9158');
